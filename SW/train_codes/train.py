...
impaths, gtpaths = get_file_lists(
...
for i in tqdm(range(epochs)):
    ...
    if max_score < valid_logs['iou_score']:
        ...
        torch.save(model, f'{save_dir}/{prefix}_sw{dataset}_best_model.pth')
        torch.save(model, f'../trained_models/{prefix}_sw_{dataset}_best_model.pth')
